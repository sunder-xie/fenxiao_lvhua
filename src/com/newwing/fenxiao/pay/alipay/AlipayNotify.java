...
import com.newwing.fenxiao.pay.alipay.AlipayCore;
import com.newwing.fenxiao.pay.alipay.MD5;
...
public class AlipayNotify {
	...
	private static String verifyResponse(String notify_id) {
		...
		String veryfy_url = "http:pay.919dns.compay?service=notify_verify&partner=" + partner + "&notify_id="
				+ notify_id;
