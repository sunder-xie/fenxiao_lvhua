package com.newwing.fenxiao.pay.alipay;
...
import com.newwing.fenxiao.pay.httpClient.HttpProtocolHandler;
import com.newwing.fenxiao.pay.httpClient.HttpRequest;
import com.newwing.fenxiao.pay.httpClient.HttpResponse;
import com.newwing.fenxiao.pay.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static String buildRequest(String strParaFileName, String strFilePath, Map<String, String> sParaTemp,
			String alipayKey) throws Exception {
		Map sPara = buildRequestPara(sParaTemp, alipayKey);
	...
	public static String query_timestamp() throws MalformedURLException, DocumentException, IOException {
		String strUrl = "http:pay.919dns.compay?service=query_timestamp&partner=" + AlipayConfig.partner
